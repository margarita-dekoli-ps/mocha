...
Runner.prototype.hooks = function(name, suites, fn) {
  ...
  function next(suite) {
    ...
    self.hook(name, function cbHook(err) {
      if (err) {
...
Runner.prototype.runTests = function(suite, fn) {
  ...
  function nextTest(err, errSuite) {
    ...
    self.hookDown(HOOK_TYPE_BEFORE_EACH, function cbHookDown(err, errSuite) {
      if (err || test.isPending()) {
        ...
        return self.hookUp(HOOK_TYPE_AFTER_EACH, function cbHookUp(e, eSuite) {
